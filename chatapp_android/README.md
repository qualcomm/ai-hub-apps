...
2. Navigate to `src/main/assets/models/llm` and use this directory to store the assets.
    ...
    - Download and save `tokenizer.json` from the [LLM On-Device Deployment](https://github.com/qualcomm/ai-hub-apps/tree/release/tutorials/llm_on_genie#genie-config) tutorial to `src/main/assets/models/llm/`.
