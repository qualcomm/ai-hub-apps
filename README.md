...
| [Object Detection](object_detection_android) | Java | TensorFlow Lite | OpenCV, Live Camera Feed |
...
| [GenieX Chat Android](geniex_chat_android) | Kotlin/Java | GenieX |
<!-- /ANDROID_APPS -->
...
| Task | Language | Inference API | Special Tags |
| -- | -- | -- | -- |
| [ChatApp](chatapp_windows_cpp) | C++ | Genie SDK | LLM, GenAI |
| [Image Classification](image_classification_windows_cpp) | C++ | ONNX | OpenCV |
| [Object Detection](object_detection_windows_cpp) | C++ | ONNX | OpenCV |
| [Super Resolution](super_resolution_windows_cpp) | C++ | ONNX | OpenCV |
...
| [SAM3 Segmentation Windows](sam3_segmentation_windows_py) | Python | ONNX |
<!-- /WINDOWS_APPS -->
...
| [Posenet Pose Estimation](posenet_ubuntu_py) | Python | TensorFlow Lite | GStreamer |
| [YamNet Audio Classification](yamnet_ubuntu_py) | Python | TensorFlow Lite |
| [Portrait Segmentation](portrait_segmentation_ubuntu_py) | Python | TensorFlow Lite |
| [Face Recognition](face_recognition_ubuntu_py) | Python | TensorFlow Lite | GStreamer |
| [3D Object Detection](object_detection_3d_ubuntu_py) | Python | TensorFlow Lite | GStreamer |
| [Semantic Segmentation](semantic_segmentation_ubuntu_py) | Python | TensorFlow Lite | GStreamer |
<!-- /UBUNTU_APPS -->
...
| [LLM on-device deployment with GenieX](tutorials/geniex) | Running and exporting Large Language Models (LLMs) with the GenieX runtime |
<!-- /TUTORIALS -->
