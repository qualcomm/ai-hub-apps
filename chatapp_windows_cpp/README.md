...
To use languages that require Unicode, follow the [UTF-8 support instructions](https://github.com/qualcomm/ai-hub-apps/blob/release/tutorials/llm_on_genie/powershell/README.md#utf-8-support).
...
1. Get QNN context binaries for the LLM of your choice from Qualcomm AI Hub. There are two ways to get these assets:
    ...
    - Read more about [exporting LLMs via AI Hub here](https://github.com/qualcomm/ai-hub-apps/tree/release/tutorials/llm_on_genie#1-generate-genie-compatible-qnn-binaries-from-ai-hub)
...
2. Download and save `tokenizer.json` from the [LLM On-Device Deployment](https://github.com/qualcomm/ai-hub-apps/tree/release/tutorials/llm_on_genie#genie-config) tutorial to `genie_bundle\`.
